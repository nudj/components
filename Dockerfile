...
COPY src /usr/src
RUN npm i
CMD ./node_modules/.bin/standard --parser babel-eslint --plugin flowtype && ./node_modules/.bin/standard && ./node_modules/.bin/mocha --compilers js:babel-core/register --recursive test
